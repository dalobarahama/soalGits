package com.example.pengalatdite.helloberita;
...
public class ListArticlesAdapter extends BaseAdapter {
    ...
    public ListArticlesAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    }
    public int getCount() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ListArticlesViewHolder holder = null;
        if (convertView == null) {
            holder = new ListArticlesViewHolder();
            ...
            holder = (ListArticlesViewHolder) convertView.getTag();
        }
